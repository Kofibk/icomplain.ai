...
export const COMPLAINT_CONFIGS = {
  ...
  // ---------------------------------------------------------------------------
  // OTHER FINANCIAL COMPLAINT
  // Catch-all for any FCA-regulated complaint not covered above
  // ---------------------------------------------------------------------------
  'other': {
    id: 'other',
    title: 'Other Financial Complaint',
    subtitle: 'Insurance, investments, mortgages, or other FCA-regulated issues',
    icon: '📝',
    baseSuccessRate: 42,
    maxSuccessRate: 78,
    ...
    regulations: {
      ...
      secondary: ['DISP 1.4', 'FCA Handbook PRIN 2.1'],
    },
    
    questions: [
      {
        id: 'product_type',
        question: 'What type of financial product or service?',
        type: 'select',
        required: true,
        options: [
          { value: 'insurance', label: 'Insurance (car, home, travel, life, pet)', successModifier: 5 },
          { value: 'mortgage', label: 'Mortgage', successModifier: 5 },
          { value: 'investment', label: 'Investment / stocks / ISA', successModifier: 8 },
          { value: 'pension', label: 'Pension / SIPP', successModifier: 10, highlight: true },
          { value: 'current_account', label: 'Current account / overdraft', successModifier: 3 },
          { value: 'savings', label: 'Savings account', successModifier: 3 },
          { value: 'payday_loan', label: 'Payday loan / high-cost credit', successModifier: 12 },
          { value: 'debt_collection', label: 'Debt collection', successModifier: 8 },
          { value: 'crypto', label: 'Cryptocurrency / digital assets', successModifier: 5 },
          { value: 'other', label: 'Other financial product', successModifier: 0 },
        ],
      },
      {
        id: 'complaint_type',
        ...
        required: true,
        options: [
          { value: 'mis_sold', label: 'I was mis-sold the product', successModifier: 12 },
          { value: 'claim_rejected', label: 'My claim was rejected', successModifier: 10 },
          { value: 'unfair_charges', label: 'Unfair fees or charges', successModifier: 8 },
          { value: 'poor_advice', label: 'I was given bad advice', successModifier: 10 },
          { value: 'account_problem', label: 'Problem with my account', successModifier: 5 },
          { value: 'data_error', label: 'Error on credit file / data issue', successModifier: 8 },
          { value: 'harassment', label: 'Harassment or unfair treatment', successModifier: 10 },
          { value: 'not_explained', label: 'Product wasn\'t explained properly', successModifier: 8 },
      ...
      },
      {
        ...
        required: true,
        options: [
          { value: 'last_6_months', label: 'In the last 6 months', successModifier: 5 },
          { value: '6_months_1_year', label: '6 months to 1 year ago', successModifier: 3 },
          { value: '1_3_years', label: '1-3 years ago', successModifier: 0 },
          { value: '3_6_years', label: '3-6 years ago', successModifier: -5, warning: 'Check time limits' },
          { value: 'over_6_years', label: 'Over 6 years ago', successModifier: -15, warning: 'May be out of time - but exceptions exist' },
        ],
        helpText: 'Generally you have 6 years from the event, or 3 years from when you became aware.',
      },
      {
        id: 'what_happened',
        question: 'Briefly describe what happened',
        type: 'text',
        required: true,
        placeholder: 'Tell us the key facts...',
      },
      {
        id: 'what_want',
        ...
        required: true,
        options: [
          { value: 'refund', label: 'Full refund of money paid', successModifier: 5 },
          { value: 'compensation', label: 'Compensation for losses', successModifier: 5 },
          { value: 'put_right', label: 'Put me back in the position I should be in', successModifier: 8 },
          { value: 'apology', label: 'Apology and acknowledgement', successModifier: 0 },
          { value: 'credit_file', label: 'Correct my credit file', successModifier: 5 },
          { value: 'other', label: 'Something else', successModifier: 0 },
        ],
      },
      {
    ...
    letterTemplate: {
      breach: 'failure to treat me fairly / breach of FCA requirements',
      regulation: 'FCA Principle 6 (Treating Customers Fairly)',
      harm: 'financial loss and/or significant distress',
      remedy: 'appropriate redress as outlined above',
    },
  },
}
